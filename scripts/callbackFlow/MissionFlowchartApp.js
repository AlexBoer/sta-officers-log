...
import { openNewMilestoneArcDialog } from "../hooks/renderAppV2/newMilestoneArcDialog.js";
import {
  getCreatedKey,
  compareKeys,
} from "../hooks/renderAppV2/sortingUtils.js";
...
export class MissionFlowchartApp extends Base {
  ...
  async _createCallbackLink(sourceNodeId, targetNodeId) {
    ...
    const { syncCallbackTargetUsedFlags } =
      await import("../hooks/renderAppV2/callbackSourceButtons.js");
