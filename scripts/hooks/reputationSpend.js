...
import { isAcclaimSurveyEnabled } from "../data/acclaimSurvey.js";
import {
  getCustomAwards,
  getCustomAcclaimOptions,
  getCustomReprimandOptions,
} from "../data/customSpendOptions.js";
...
export async function triggerAllPlayersAcclaimSurvey() {
  ...
  const { showGMSurveyMonitor } =
    await import("./renderAppV2/gmSurveyMonitor.js");
